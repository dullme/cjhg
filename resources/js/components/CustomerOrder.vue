                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                    <input id="commission" v-model="form_data.commission" type="text" class="form-control" placeholder="佣金">
                                </div>
                            </div>
                        </div>

                        <div class="form-group ">
                            <label class="col-sm-2 asterisk control-label">物流公司</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                    <select class="form-control" id="logistics">
                                        <option value="">请选择</option>
                                        <option v-for="logistic in logistics" :value="logistic.name">{{ logistic.name }}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            <label class="col-sm-2  control-label">提货运费</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                    <input id="pick_up" v-model="form_data.pick_up" type="text" class="form-control" placeholder="运费">
                                </div>
                            </div>
                        </div>

                        <div class="form-group ">
                            <label class="col-sm-2  control-label">运输运费</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                    <input id="transportation" v-model="form_data.transportation" type="text" class="form-control" placeholder="运费">
                                </div>
                            </div>
                        </div>

                        <div class="form-group ">
                            <label class="col-sm-2  control-label">送货运费</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                    <input id="deliver_goods" v-model="form_data.deliver_goods" type="text" class="form-control" placeholder="运费">
                                </div>
                            </div>
                        </div>

                        <div class="form-group ">
                            <label class="col-sm-2 asterisk control-label">下单时间</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                        ...
                        <div class="form-group ">
                            <label class="col-sm-2  control-label">提货对象</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                    <input id="pick_up_object" v-model="form_data.pick_up_object" type="text" class="form-control" placeholder="提货对象">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                    <input id="pick_up_date" v-model="form_data.pick_up_date" type="text" class="form-control datetime-picker" placeholder="提货日期">
                                </div>
                            </div>
                        </div>

                        <div class="form-group ">
                            <label class="col-sm-2 asterisk control-label">付款方式</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                    <select class="form-control" v-model="form_data.payment_method">
                                        <option :value="key" v-for="(value,key) in payment_method">{{ value }}</option>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <textarea id="remarks" class="form-control" rows="4" v-model="form_data.remarks" placeholder="备注"></textarea>
                            </div>
                        </div>


                        <div class="form-group  ">
                            <label class="col-sm-2 asterisk control-label">选择产品</label>
                            <div class="col-sm-8">
                                <table class="table table-hover" id="table-fields">
                                    <tbody>
                                    <tr>
                                        <th>产品</th>
                                        <th style="width: 100px">含量</th>
                                        <th style="width: 150px">单价<span style="color: #e3342f"> (税率：{{ config.vat }}%)</span></th>
                                    ...
                                    <tr v-for="(item) in form_data.items" :key="item.length" v-if="item.deleted== false">
                                        ...
                                        <td>
                                            <input type="text" class="form-control" value=""
                                                   @keyup="item.content = $event.target.value" placeholder="含量" >
                                        </td>
                                        <td>
...
<script>
    ...
    export default {
        ...
        created() {
            axios.get('/admin/configs').then(response => {
                this.config = response.data
            });
            axios.get('/admin/api/customers').then(response => {
                this.customers = response.data
            });
            axios.get('/admin/api/can-sales-items').then(response => {
                this.select_items = response.data
            });

            axios.get('/admin/api/logistics').then(response => {
                this.logistics = response.data
            });
            axios.get('/admin/api/payment-method').then(response => {
        ...
        mounted() {
            ...
            $('#pick_up_date').on('dp.change', (e) => {
                this.form_data.pick_up_date = e.currentTarget.value;
            });
            ...
            $('#logistics').select2().on('change', (e) => {
                this.form_data.logistics = e.target.value
            });
        },
        ...
        methods: {
            ...
            submit(){
                if(this.validate()){
                    axios({
                        method: 'post',
                        url: '/admin/customer-orders/save',
                        data: this.form_data
                    }).then(response => {
                        ...
                        if (response.data.status) {
                            swal(
                                ...
                                location.href="/admin/customer-orders";
                            });
                        }else{
